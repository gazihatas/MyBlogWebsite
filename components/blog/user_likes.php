...
<title> Beğenilen Gönderiler </title>
</head>
                                                                                            ...
                                                                                            <div class="blog-post_info">
                                                                                                ...
                                                                                                <div style="display: flex; justify-content: space-between;">
                                                                                                    ...
                                                                                                    <div style="margin-bottom:20px; margin: 15px;">
                                                                                                        ...
                                                                                                        <br>
                                                                                                        <!-- Yorum -->
                                                                                                        <a href="view_post.php?post_id=<?= $post_id; ?>"><i class='bx bx-message-square-dots' style="font-size: 30px;"></i><span>(<?= $total_post_likes; ?>)</span></a>
                                                                                                        <!-- Beğeni -->
